  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Intenta recargar o volver al inicio.</p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-outline">Inicio</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Starpil · Lyznyz Academia — Tienda profesional de depilación" },
      {
        name: "description",
        content:
          "Tienda oficial Lyznyz Academia con productos profesionales Starpil para depilación facial y corporal. Pre, durante y post depilación.",
      },
      { property: "og:title", content: "Starpil · Lyznyz Academia" },
      { property: "og:description", content: "Productos profesionales Starpil comercializados por Lyznyz Academia." },
